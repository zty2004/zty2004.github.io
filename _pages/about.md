...
<div class="academic-home">
  ...
  <!-- <section class="home-section">
    ...
    <div class="pub-item">
      ...
      <h3>An Awesome Paper Title About Something Important</h3>
      <p class="pub-authors"><strong>Your Name</strong>, Coauthor A, Coauthor B</p>
      <p class="pub-links">
        <a href="#">[PDF]</a>
        <a href="#">[Code]</a>
    ...
    <div class="pub-item">
      <span class="pub-venue pub-venue-project">Project</span>
      <h3>PostAutoGenerator</h3>
      <p class="pub-authors">A small C++ tool that auto-generates Jekyll travel posts from photo folders.</p>
      <p class="pub-links">
